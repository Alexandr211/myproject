  ...
  {	  
    ...
    if($_SESSION['cart']) return true; 
	  ...
	  // формируем интерфейс для работы с корзиной
			$table_cart="<table bgcolor='#E6DEEA' border='1' class='table_cart'><tr><th>№</th><th>Product details</th><th>Unite price</th><th>Quantity</th><th>Total Price</th><th>Action</th></tr>";
			$i=1;
			foreach($product_positions as $product)
			{
			...
			$table_cart.="<tr><td colspan='3'></td><td>Grand Total: </td><td><strong> <span style='color: #7F0037'>$".$total_summ."</span></strong></td><td></td></tr></table>";
